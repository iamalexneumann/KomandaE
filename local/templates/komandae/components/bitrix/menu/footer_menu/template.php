...
foreach ($arResult as $arItem):
    ...
    <li class="col-sm-6 footer-menu__col">
        <a<?php if ($arItem['SELECTED'] !== true && $arItem['LINK']): ?> href="<?= $arItem['LINK']; ?>"<?php endif; ?>
           class="footer-menu__title<?php if ($arItem['SELECTED']):?> footer-menu__submenu-title_active<?php endif; ?>"><?= $arItem['TEXT']; ?></a>
...
?>
    <li>
        <a<?php if ($arItem['SELECTED'] !== true): ?> href="<?= $arItem['LINK']; ?>"<?php endif; ?>
           class="<?php if ($arItem['SELECTED']):?> active<?php endif; ?>"><?= $arItem['TEXT']; ?></a>
        <ul>
<?php
        endif;
